...
regions.push(path);
        ...
        13: [function (_dereq_, module, exports) {
            ...
            agentAdder.prototype.add = function (nodes, grid2,checker) {
                var addStart=[];
                //var startX=[], startY=[];
                // for (var i=0;i<nodes.length;i++){
                //     startX.push(nodes[i].x);
                //     startY.push(nodes[i].y);
                // }
                ...
                while (!checker.checkStart(nodes,grid2)){
        ...
        14: [function (_dereq_, module, exports) {
            ...
            DepthFirstChecker.prototype.checkStart = function (nodes, grid2) {
